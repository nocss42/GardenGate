...
#define OFFSET_SERVERPLAYER_LEAVEINGAME HOOK_OFFSET(0) 
#define OFFSET_SERVERPLAYER_DISCONNECT HOOK_OFFSET(0) 

#define OFFSET_SERVERPEER_DELETECONNECTION HOOK_OFFSET(0)
#define OFFSET_SERVERPEER_CONNECTIONFORPLAYER HOOK_OFFSET(0)

#define OFFSET_SERVERCONNECTION_DISCONNECT HOOK_OFFSET(0)
#define OFFSET_SERVERCONNECTION_KICKPLAYER HOOK_OFFSET(0x1407056D0)

#define OFFSET_SERVERPLAYERMANAGER_DELETEPLAYER HOOK_OFFSET(0)

#define OFFSET_APPLY_SETTINGS HOOK_OFFSET(0)
#define OFFSET_CLIENT_INIT_NETWORK HOOK_OFFSET(0)
#define OFFSET_CLIENT_CONNECTTOADDRESS HOOK_OFFSET(0x140559CD0)

#define OFFSET_SERVER_PATCH (0x14161DC10)

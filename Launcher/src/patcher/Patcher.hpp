...
{
public:
    static bool IsGW1Patched(const std::string& gamePath);
    static bool AutoPatchGW1(const std::string& gamePath, const std::string& dllFile, std::string& errorMessage);
    static bool RestoreGW1(const std::string& gamePath, std::string& errorMessage);

    static bool IsGW2Patched(const std::string& gamePath);
    static bool AutoPatchGW2(
        const std::string& gamePath, const std::string& patchFile, const std::string& dllFile, std::string& errorMessage);
